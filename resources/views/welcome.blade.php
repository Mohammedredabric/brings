        ...
        <div class="card text-center w-100 mb-0">
          ...
          <div class="card-content">
            ...
            <div class="d-flex justify-content-center my-2">
              <a class="btn btn-primary btn-sm  " href="{{route('admin.login')}}">Admin</a>
              <a class="btn btn-warning btn-sm mx-1" href="{{route('customer.login')}}">Customer</a>
              <a class="btn btn-secondary btn-sm " href="{{route('deliverymen.login')}}" >DeliveryMen</a>
            </div>
          </div>
        </div>
      </div>
