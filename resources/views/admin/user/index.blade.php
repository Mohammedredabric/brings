                  ...
                  @isset($admins)
                    @foreach($admins as $admin)
                      <tr>
                        ...
                        <td>
                          <div class="d-flex ">
                            <a href="{{route('user.show',$admin->id)}}"  class="btn btn-icon btn-icon  btn-flat-warning mr-1 mb-1 waves-effect waves-light"><i class="feather icon-eye warning"></i></a>
                            <a href="{{route('user.edit',$admin->id)}}"  class="btn btn-icon btn-icon  btn-flat-primary mr-1 mb-1 waves-effect waves-light"><i class="feather icon-edit primary"></i></a>
